...
class Student {
    ...
    // this.name = s1.name;
    // this.roll = s1.roll;
    // this.marks = s1.marks; // this ia an array here whole array didn't copy here
    // but here only reference
    // copy here
    // }
    ...
    Student(Student s1) {
        ...
        for (int i = 0; i < marks.length; i++) {
            this.marks[i] = s1.marks[i]; // here we are deep copying the values 1 by 1
        }
